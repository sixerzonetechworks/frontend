...
import { formatDate, getDayName, isValidEmail, isValidPhone } from '../utils/helpers';
          ...
          <div className="summary-details">
            ...
            {(backendTotalAmount !== null ? (
              <div className="summary-item price-highlight">
                ...
                <span className="summary-value price-amount">₹{backendTotalAmount}</span>
              </div>
            ) : (
              selectedGround.price && (
                <div className="summary-item price-highlight">
                  <span className="summary-label">Total Amount:</span>
                  <span className="summary-value price-amount">₹{selectedGround.price}</span>
                </div>
              )
            ))}
          </div>
